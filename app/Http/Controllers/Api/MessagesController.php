                            ...
                            case  'ccrp':
                                ...
                                if ($user_app) {
                                    ...
                                    if ($ccrp_company) {
                                        ...
                                        $total += $message['ccrp']['warning_event'] = WarningEvent::whereIn('company_id', $company_ids)->where('handled', 0)->count();
                                        $total += $message['ccrp']['warning_sender_event'] = WarningSenderEvent::whereIn('company_id', $company_ids)->where('handled', 0)->count();
                                    }
                                }
                                break;
                        }
